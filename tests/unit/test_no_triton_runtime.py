...
def test_package_imports_without_triton(without_triton) -> None:
    """`import triton_tritonflow` must not need the compiler it can optionally drive."""
    module = importlib.import_module("triton_tritonflow")
    assert module is not None


def test_extract_package_imports_without_triton(without_triton) -> None:
    module = importlib.import_module("triton_tritonflow.extract")
