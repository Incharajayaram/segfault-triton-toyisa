...
def transfer_report(
    ...
    Args:
        ...
        baseline_isa: Initial ISA name (default "tritonflow1").
        target_isa: Transferred ISA name (e.g. "tritonflow2" or "vortex_rvgpu").
