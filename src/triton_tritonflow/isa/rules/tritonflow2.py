...
`recognize/op_shapes.py`) WITHOUT reading `isa/rules/tritonflow1.py` — the fact is
...
copying. The candidate lists are tritonflow2's own instruction names and are
...
#: ISA-2's rule table. Candidates mirror `isa/schemas/tritonflow2.yaml`.
