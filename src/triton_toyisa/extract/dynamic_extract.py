...
def compile_triton_kernel(
    ...
    except Exception as exc:  # noqa: BLE001 - the compiler's own diagnostic is the payload
...
class CompileSpy:
    ...
    def __enter__(self) -> CompileSpy:
        ...
        def wrapper(*args: Any, **kwargs: Any) -> Any:
            ...
            except Exception as exc:  # noqa: BLE001 - observing must not break compiling
...
class Extracted:
    ...
    def pads(self) -> tuple[int, int, int]:
        ...
        return tuple(p - q for p, q in zip(self.padded, self.problem))  # type: ignore[return-value]
