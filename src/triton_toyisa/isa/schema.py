...
#: selected against. ISA-1 stays the module default (4); toyisa2 declares 8.
...
SCHEMA_ALIGNMENT_WORDS: dict[str, int] = {"toyisa1": 4}
...
def load_schema(path: str | os.PathLike[str]) -> IsaSchema:
    ...
    # promise differently from ISA-1's 4 (toyisa2 declares 8, banked).
...
def load_builtin(name: str = "toyisa1") -> IsaSchema:
    """Load a schema shipped with the package (`toyisa1`, later `toyisa2`)."""
