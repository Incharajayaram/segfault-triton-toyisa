...
```
src/triton_tritonflow/ttir/lexer.py                    tokenize, strip_comments
src/triton_tritonflow/ttir/parser.py                   parse_raw -> RawModule
src/triton_tritonflow/harness/extract_fixtures.py      extract, TIER_KERNELS
