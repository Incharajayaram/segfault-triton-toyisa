...
- `src/triton_toyisa/emu/cpp/` - Complete C++ implementation
...
- `src/triton_toyisa/emu/hardware.py` - Hardware abstraction layer
- `src/triton_toyisa/lower.py` - Lowering utilities
- `src/triton_toyisa/isa/schemas/vortex_rvgpu.yaml` - Vortex RISC-V GPU ISA schema
