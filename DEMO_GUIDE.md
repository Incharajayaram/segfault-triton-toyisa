...
# 1. Check imports
python3 -c "import sys; sys.path.insert(0, 'src'); from triton_toyisa.lower import lower_fixture; print('✅')"
...
# 4. Check PyTorch
python3 -c "import sys; sys.path.insert(0, 'src'); from triton_toyisa.torch_backend.compiler import toyisa_backend; print('✅')"
